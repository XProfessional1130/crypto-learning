...
import MessageBubble, { personalityImages } from '@/components/features/chat/MessageBubble';
import PersonalitySelector from '@/components/features/chat/PersonalitySelector';
import SuggestedPrompts from '@/components/features/chat/SuggestedPrompts';
import { formatMessageContent, samplePrompts } from '@/components/features/chat/utils';
