...
import { GlobalData, getBtcPrice, getEthPrice, getGlobalData, fetchCoinData, fetchMultipleCoinsData } from '@/lib/api/coinmarketcap';
import { 
...
} from '@/lib/api/supabase-crypto';
import { getMacroMarketData, MacroMarketData } from '@/lib/api/macro-market-data';
