...
export default function Discounts() {
  ...
  return (
    <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <motion.div 
        className="neo-glass rounded-xl mb-8 p-4 flex flex-col md:flex-row gap-4 items-center border border-white/10 dark:border-white/5"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      {/* Discounts Grid - with enhanced animations */}
      {isLoading ? (
        <motion.div 
      ...
      {/* Enhanced Referral Program - with improved animations and effects */}
      <motion.div 
        className="mt-16 neo-glass rounded-xl p-8 text-center relative overflow-hidden border border-white/10 dark:border-white/5"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
